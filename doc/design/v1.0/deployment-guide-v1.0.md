...
- [1. Overview](#1-overview)
  ...
  - [1.2 Deployment Options](#12-deployment-options)
- [2. Prerequisites](#2-prerequisites)
  - [2.1 System Requirements](#21-system-requirements)
  - [2.2 Software Requirements](#22-software-requirements)
- [3. Architecture](#3-architecture)
  - [3.1 Current Architecture (Monolithic)](#31-current-architecture-monolithic)
  - [3.2 Service Components](#32-service-components)
- [4. Setup (Development & Simple Deployment)](#4-setup-development--simple-deployment)
  ...
  - [4.4 Dockerfile](#44-dockerfile)
  - [4.5 Development Commands](#45-development-commands)
- [5. Deploying to a Server (Optional)](#5-deploying-to-a-server-optional)
  - [5.1 Overview](#51-overview)
  - [5.2 Server Setup](#52-server-setup)
  - [5.3 Dockerfile (Same for Dev and Deployment)](#53-dockerfile-same-for-dev-and-deployment)
  - [5.4 Nginx Configuration](#54-nginx-configuration)
  - [5.5 Deployment Steps](#55-deployment-steps)
- [5. Configuration](#5-configuration)
  - [5.1 Environment Variables](#51-environment-variables)
  - [5.2 Database Configuration](#52-database-configuration)
  - [5.3 Redis Configuration](#53-redis-configuration)
- [6. Monitoring & Maintenance](#6-monitoring--maintenance)
  - [6.1 Health Checks](#61-health-checks)
  - [6.2 Logging](#62-logging)
  - [6.3 Backup](#63-backup)
  - [6.4 Updates](#64-updates)
- [7. Troubleshooting](#7-troubleshooting)
  - [7.1 Common Issues](#71-common-issues)
  - [7.2 Performance Issues](#72-performance-issues)
- [9. Security Considerations](#9-security-considerations)
  - [9.1 Security Checklist (If Deploying to Server)](#91-security-checklist-if-deploying-to-server)
