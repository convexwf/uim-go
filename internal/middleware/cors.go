...
//
// It checks if the request origin is in the allowed origins list
// and sets appropriate CORS headers. It also handles preflight OPTIONS requests.
//
// Parameters:
//   - cfg: The application configuration containing CORS settings
//
// Returns:
